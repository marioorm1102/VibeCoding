      ...
      <div className="max-w-4xl mx-auto relative z-10 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-4 mb-12 md:mb-16">
          <button 
            ...
            className={`px-6 md:px-8 py-3 md:py-4 rounded-full font-mono text-xs md:text-sm uppercase tracking-widest transition-all shadow-sm ${mode === 'tradicional' ? 'bg-black text-white ring-2 ring-black/20' : 'bg-white border border-black/10 text-black hover:border-black hover:text-black'}`}
          >
            <Terminal className="w-4 h-4 md:w-5 md:h-5 inline-block mr-2" /> Tradicional
          </button>
          <button 
            type="button"
